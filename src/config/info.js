        ...
        description: () => (
            <p className="about-text">
                <ul>
                    <li>
                        {" "}
                        Created a <span>Static Data Viewer</span> (ReactJS,
                        Spring) that converts XML data into a human readable
                        grid format, allows editing and shows diff across
                        versions. Received{" "}
                        <span>Employee of the Month Award </span> (Feb 2023)
                    </li>
                    <li>
                        {" "}
                        Created a <span>Review System </span> (ReactJS, Spring,
                        C++, MS SQL Server) that suspends any DB data
                        modification coming from 3rd party source systems until
                        required approvals are not in place. Received{" "}
                        <span>Employee of the Month Award </span> (Jan 2024)
                    </li>
                    <li>
                        {" "}
                        Collaborated with squads like FX, Rates and XVA across
                        India, Australia and Singapore to add new
                        functionalities, fix bugs and improve performance.
                    </li>
                </ul>
            </p>
        ),
    },
    {
        ...
        description: () => (
            <p className="about-text">
                <ul>
                    <li>
                        Developed a <span>Live classes Portal</span> which
                        included features like creating and monitoring classes;
                        resolving doubts etc.
                    </li>
                    <li>
                        Using ReactJS, made the entire UI, ranging from CSS to
                        API Integration.
                    </li>
                    <li>
                        Created the models and Rest API used by the UI in Django
                        Rest Framework
                    </li>
                    <li>
                        {" "}
                        Hosted Jitsi Meet on an AWS EC2 instance which was used
                        to host classes
                    </li>
                </ul>
            </p>
...
export const info = {
    about: () => (
        <p className="about-text">
            I graduated from <span>IIT Delhi</span> in 2022 and since then have
            been working to make seamless web applications.
            <br /> As a <span>full-stack developer</span>, I wield a versatile
            toolkit that empowers me to create and manage entire web
            applications. On the front end, I have crafted interactive user
            interfaces using ReactJS. On the back end, I have worked with
            Node.js and Spring to build robust server-side logic.
            <br /> In my free time, I like to play video games, do competitive
